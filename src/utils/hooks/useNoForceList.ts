...
const useIndex = (
  ...
  const onRefresh = useCallback(() => {
    setRefreshing(true)
    listGet(url, paginationDefault, mapDefault, queryCondition, sort, full_fields)
      .then(res => {
        const { data, page } = res
        setRefreshing(false)
        setList(data)
  ...
  }, [full_fields, mapDefault, queryCondition, sort, url])

  // useFocusEffect(useCallback(() => {}, [mapDefault, queryCondition, sort, spinningChange, url]))
  ...
  }, [full_fields, mapDefault, queryCondition, sort, spinningChange, url])
